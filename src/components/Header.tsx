...
const Header = () => {
  ...
  return <header className="fixed top-0 left-0 right-0 z-50 bg-offwhite/95 backdrop-blur-sm border-b-2 border-bordeaux">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        {isMenuOpen && <nav className="lg:hidden py-6 border-t border-border">
            <div className="flex flex-col gap-4">
              ...
              <a href="#nieuwsbrief" onClick={() => setIsMenuOpen(false)} className="mt-4 px-6 py-3 bg-bordeaux text-primary-foreground text-sm font-medium tracking-wide uppercase text-center hover:bg-bordeaux-dark transition-colors">
                Nieuwsbrief
              </a>
            </div>
          </nav>}
